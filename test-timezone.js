// 测试时区和日期设置
console.log('当前时区:', process.env.TZ);
console.log('当前日期:', new Date().toString());
console.log('当前日期（ISO格式）:', new Date().toISOString());
...
// 测试固定日期
const testDate = '2024-05-24';
const testLunar = getLunarDate(testDate);
console.log('\n固定日期测试:');
console.log('公历:', testDate);
console.log('农历:', testLunar);
